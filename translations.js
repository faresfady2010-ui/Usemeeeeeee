...
var translations = {
  en: {
    ...
    labelZoom: "text size", zoomDesc: "Scales the entire interface across all pages",
  ...
  es: {
    ...
    labelZoom: "Tamaño del texto", zoomDesc: "Escala toda la interfaz en todas las páginas",
  ...
  fr: {
    ...
    labelZoom: "Taille du texte", zoomDesc: "Redimensionne toute l'interface sur toutes les pages",
  ...
  de: {
    ...
    labelZoom: "Textgröße", zoomDesc: "Skaliert die gesamte Oberfläche auf allen Seiten",
  ...
  ar: {
    ...
    labelZoom: "حجم النص", zoomDesc: "يقوم بتغيير حجم الواجهة بأكملها عبر جميع الصفحات",
